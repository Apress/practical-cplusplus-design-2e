...
void InputWidget::InputWidgetImpl::setupShortcuts()
{
    ...
    plusButton_->registerShortcut(QKeySequence{static_cast<int>(Qt::SHIFT) | static_cast<int>(Qt::Key_Plus)});
    ...
    multiplyButton_->registerShortcut(QKeySequence{static_cast<int>(Qt::SHIFT) | static_cast<int>(Qt::Key_Asterisk)});
